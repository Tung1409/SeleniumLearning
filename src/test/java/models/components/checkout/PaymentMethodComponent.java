...
public class PaymentMethodComponent extends Component {
    ...
    public final static By purchaseOrderSel = By.cssSelector("[value='Payments.CashOnDelivery']");
    public final static By continueBtnSel = By.cssSelector(".button-1.payment-method-next-step-button");
